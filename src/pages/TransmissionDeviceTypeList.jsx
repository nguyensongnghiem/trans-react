...
function TransmissionDeviceTypeList() {
    ...
    const validationSchema = Yup.object({
        name: Yup.string().required("Tên loại thiết bị là bắt buộc"),
    });
                ...
                <table className="w-full min-w-max table-auto text-left">
                    <thead>
                        <tr className="bg-gray-50 border-b border-gray-200">
                            ...
                            <th className="p-4">
                                <Typography variant="small" color="blue-gray" className="font-bold">Tên loại thiết bị</Typography>
                            </th>
...
export default TransmissionDeviceTypeList;
