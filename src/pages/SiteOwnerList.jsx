                ...
                <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-4 py-3">
                    <div>
                        ...
                        <Typography className="text-xs font-normal text-gray-500 mt-0.5">
                            Nhập thông tin chủ trạm mới vào hệ thống
                        </Typography>
                    </div>
                    <IconButton
                        size="sm"
            ...
            >
                <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-4 py-3">
                    <div>
                        ...
                        <Typography className="text-xs font-normal text-gray-500 mt-0.5">
                            Chỉnh sửa thông tin chủ trạm #{selectedItem?.id}
                        </Typography>
                    </div>
                    <IconButton
                        size="sm"
            ...
            >
                ...
                <DialogBody className="p-6 text-blue-gray-700">
                    <Typography variant="paragraph" color="blue-gray" className="font-medium">
                        Bạn có chắc chắn muốn xóa chủ trạm <b>{selectedItem?.name}</b>?
                    </Typography>
                    <Typography variant="small" color="gray" className="mt-3 italic">
                        Hành động này không thể phục hồi và có thể ảnh hưởng đến các dữ liệu liên quan.
                    </Typography>
                </DialogBody>
