                ...
                <thead className="bg-gray-50 sticky top-0 z-10 border-b border-gray-200">
                    <tr>
                        ...
                        <th className="p-4 border-b border-gray-200 text-right">
                         ...
                         <th className="p-4 border-b border-gray-200 text-right">
                            <Typography variant="small" color="blue-gray" className="font-bold opacity-70 leading-none">Chiều dài (m)</Typography>
                        </th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr key={index} className="hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-0">
                            ...
                            <td className="p-4">
                                <Chip 
                                    ...
                                    value="Cáp thuê" 
                                    color="blue"
                                    className="rounded-md border-blue-200 text-blue-800 normal-case font-medium"
                                />
                            </td>
                             <td className="p-4">
                                <div className="flex flex-col">
                                    <span className="text-xs text-gray-500">Từ: <span className="font-semibold text-gray-700">{ofc.nearSite?.siteId}</span></span>
