...
function SiteTypeList() {
    ...
    const handleCreate = async (values, { resetForm }) => {
        try {
            await axiosInstance.post("site-type", values);
    ...
    const handleUpdate = async (values) => {
        try {
            await axiosInstance.put(`site-type/${selectedItem.id}`, values);
    ...
    const handleDelete = async () => {
        try {
            await axiosInstance.delete(`site-type/${selectedItem.id}`);
    ...
    const validationSchema = Yup.object({
        name: Yup.string().required("Tên loại CSHT là bắt buộc"),
    });
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen font-sans">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Quản lý Loại cơ sở hạ tầng</h1>
                ...
                <table className="w-full min-w-max table-auto text-left">
                    <thead>
                        <tr className="bg-gray-50 border-b border-gray-200">
                            ...
                            <th className="p-4">
                                <Typography variant="small" color="blue-gray" className="font-bold">Tên loại CSHT</Typography>
                            </th>
                            {isAdmin && (
                ...
                <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-4 py-3">
                    <div>
                        ...
                        <Typography className="text-xs font-normal text-gray-500 mt-0.5">
                            Nhập tên loại cơ sở hạ tầng mới
                        </Typography>
                    </div>
                    <IconButton
                        size="sm"
                                    ...
                                    <Field name="name">
                                        {({ field }) => (
                                            <Input
                                                {...field}
                                                size="lg"
                                                placeholder="VD: Cột anten, Nhà trạm..."
            ...
            >
                <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-4 py-3">
                    <div>
                        ...
                        <Typography className="text-xs font-normal text-gray-500 mt-0.5">
                            Chỉnh sửa tên loại cơ sở hạ tầng #{selectedItem?.id}
                        </Typography>
                    </div>
                    <IconButton
                        size="sm"
            ...
            >
                ...
                <DialogBody className="p-6 text-blue-gray-700">
                    <Typography variant="paragraph" color="blue-gray" className="font-medium">
                        Bạn có chắc chắn muốn xóa loại CSHT <b>{selectedItem?.name}</b>?
                    </Typography>
